	...
	<div class="orders">
	   <div class="row">
		  <div class="col-xl-12">
			 <div class="card">
				<div class="card-body">
				   <h4 class="box-title">Categories &nbsp; &nbsp; &nbsp; <a class="btn btn-success" href="manage_categories.php">Add Category</a> </h4>
				</div>
				<div class="card-body--">
						 ...
						 <tbody>
							...
							<tr>
							   ...
							   <td>
								<?php
								if($row['status']==1){
									echo "<span class='badge badge-pending'><a href='?type=status&operation=deactive&id=".$row['id']."'>Dective</a></span>&nbsp;";
								}else{
